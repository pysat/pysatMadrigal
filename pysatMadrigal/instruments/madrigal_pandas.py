...
::
    ...
    dmsp_abi = pysat.Instrument('madrigal', 'pandas', '180', kindat='17110')
...
platform = 'madrigal'
name = 'pandas'
tags = general.known_madrigal_inst_codes(pandas_format=True)
...
fname = '*{{year:4d}}{{month:02d}}{{day:02d}}*.{{version:03d}}.{file_type}'
...
def list_remote_files(tag, inst_id, kindat='', user=None, password=None,
                      supported_tags=None, url="http://cedar.openmadrigal.org",
